...
def mha_to_image(input_file, output_file, slice_index=None, output_size=None, square=True, normalize=False, 
                 window_center=None, window_width=None):
    """
    Extract a single slice from an MHA file and save it as PNG, TIFF, or Numpy format.
...
def main():
    parser = argparse.ArgumentParser(description='Extract a single slice from an MHA file and save as PNG, TIFF, or NPY')
